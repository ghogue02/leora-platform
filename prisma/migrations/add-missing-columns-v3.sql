-- ============================================================================
-- Leora Platform: Add Missing Columns Migration (v3 - Simplified)
-- ============================================================================
--
-- Purpose: Add only missing columns, no complex data migrations
-- Database uses camelCase with quoted identifiers
--
...
-- ============================================================================
-- ORDERS: Add missing columns (only truly missing ones)
-- ============================================================================
...
-- Note: orders already has subtotal, tax, total columns
...
-- Set line numbers for existing order lines (if they exist)
DO $$
BEGIN
...
-- Note: order_lines may already have quantity, unitPrice, subtotal columns
